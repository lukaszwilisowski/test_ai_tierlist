...
RESULTS_DIR="$SCRIPT_DIR/phase2-results"
...
6. Create the secret file in .secrets/vegetables/$VEGETABLE.json"
  ...
  echo -e "${BLUE}📝 Files created: $CREATED_FILES/7${NC}"

  if [ $CREATED_FILES -eq 7 ]; then
