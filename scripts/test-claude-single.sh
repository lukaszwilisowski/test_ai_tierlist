...
# Test single model with Claude Code CLI: garlic (Sonnet 4.5)
# Much faster than copilot CLI

VEGETABLE="garlic"
MODEL_NAME="Sonnet 4.5"
EMOJI="🧄"
BRANCH_NAME="impl/model-garlic"
...
# Create prompt (simpler for Claude)
...
# Run claude CLI (much faster!)
echo "🚀 Testing $VEGETABLE ($MODEL_NAME) with Claude Code..."
